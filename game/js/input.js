...
!function() {
    ...
    cc.cuties.m(function(cutie) {
      ...
      if(cc.ls.d.tempClickStreakPassive) {
        if(cc.stats.mpcost(1, true)) {
          ...
          $('#temp-mp-button-2').html('1 &#128432; + 1+0.01% &spades; = &diams;&diams;&diams;&diams; (&#9745;)<br>&diams; ' + xp + '<br><br><img src="http://zippy.gfycat.com/AmpleDescriptiveBlackfootedferret.gif" width="150px">');
          $('#cutie-bar-r .cutie-card .glyph').css('fontSize', '5rem').html('&diams; ' + xp);
        } else {
          $('#temp-mp-button-2').html('1 &#128432; + 1+0.01% &spades; = &diams;&diams;&diams;&diams; (&#9745;)<br>&#9888; 0 &clubs;<br><br><img src="http://zippy.gfycat.com/AmpleDescriptiveBlackfootedferret.gif" width="150px">');
  ...
  $('#cutie-bar-r, #temp-mp-button-2').click(function() {
    ...
    if(cc.ls.d.tempClickStreakPassive) {
      $('#temp-mp-button-2').html('1 &#128432; + 1+0.01% &spades; = &diams;&diams;&diams;&diams; (&#9745;)<br><br><img src="http://zippy.gfycat.com/AmpleDescriptiveBlackfootedferret.gif" width="150px">');
    } else {
      $('#temp-mp-button-2').html('1 &#128432; + 1+0.01% &spades; = &diams;&diams;&diams;&diams; (&#10060;)');
